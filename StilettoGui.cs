...
namespace Stiletto
{
    internal static class StilettoGui
    {
        ...
        private static void RegisterMakerControls(Stiletto plugin, RegisterSubCategoriesEvent e)
        {
            ...
            button_Save = e.AddControl(new MakerButton("Save", category, plugin));
            ...
            button_Save.OnClick.AddListener(OnSaveClick);
        }
        ...
        internal static void UpdateMakerValues(HeelInfo heelInfo)
        {
            ...
            if (text_heelName != null) 
            {
                text_heelName.Text = heelInfo.name;
            }
        }
        ...
        private static void OnSaveClick()
        {
            ...
            if (heelInfo != null) 
            {
                HeelConfigHelper.SaveHeelFile(heelInfo.name, new HeelConfig
                {
                    AngleAnkle = heelInfo.angleA.eulerAngles.x, 
                    AngleLeg = heelInfo.angleLeg.eulerAngles.x, 
                    Height = heelInfo.height.y
                });
            }
        }
